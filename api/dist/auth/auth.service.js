...
let AuthService = class AuthService {
    ...
    updateBalance(username, balance) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userModel.findOne({ email: username }).exec();
            if (!user) {
    ...
    updateCentralWallet(amount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let centralWallet = yield this.userModel.findOne({ email: 'central-wallet@phoenix-trading.frx' }).exec();
            if (!centralWallet) {
